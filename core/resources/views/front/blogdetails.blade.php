		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-title-item text-center">
					<h2 class="title">{{ __('News') }}</h2>
					<ul class="breadcrumb-nav">
						<li class=""><a href="{{ route('front.index') }}">{{ __('Home') }} </a></li>
						<li class=""><a href="{{ route('front.blogs') }}">{{ __('News') }} </a></li>
						<li class="active" aria-current="page">{{ __('News Details') }}</li>
					</ul>
				</div> <!-- page title -->
			</div>
		</div> <!-- row -->
			...
			<div class="col-lg-4  order-first order-lg-last">
				<div class="blog-sidebar">
					<div class="widget search-widget">
						<h4 class="widget-title">{{ __('Search News') }}</h4>
