		...
		<div class="row">
			<div class="col-lg-12">
				<div class="page-title-item text-center">
					<h2 class="title"><?php echo e(__('News')); ?></h2>
						<ul class="breadcrumb-nav">
							<li class=""><a href="<?php echo e(route('front.index')); ?>"><?php echo e(__('Home')); ?> </a></li>
							<li class="active" aria-current="page"><?php echo e(__('News')); ?></li>
						</ul>
				</div> <!-- page title -->
			</div>
		</div> <!-- row -->
				...
				<div class="blog-standard">
					<?php if(count($blogs) == 0): ?>
						<div class="col-md-12">
							...
							<h3 class="text-center"><?php echo e(__('NO NEWS FOUND')); ?></h3>
							</div>
						</div>
					<?php else: ?>
					<div class="row">
			...
			<div class="col-lg-4  order-first order-lg-last">
				<div class="blog-sidebar">
					<div class="widget search-widget">
						<h4 class="widget-title"><?php echo e(__('Search News')); ?></h4>
							<form action="<?php echo e(route('front.blogs', ['category' => request()->input('category'), 'month' => request()->input('month'), 'year' => request()->input('year')])); ?>" method="GET">
								<div class="input-box">
									...
									<input name="term" type="text" placeholder="<?php echo e(__('Search News')); ?>..." value="<?php echo e(request()->input('term')); ?>">
					...
					<div class="widget tags-widget">
						<h4 class="widget-title"><?php echo e(__('Archive')); ?></h4>
						<ul>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/website/core/resources/views/front/blogs.blade.php ENDPATH**/ ?>